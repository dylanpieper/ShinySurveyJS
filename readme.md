...
3.  Access with URL parameters:
    ...
    -   With tokenization (token_active = TRUE): `http://your-app-url.com/?survey=RhinocerosOvalTwoHundredTwentySevenTealStardust&entity=MeteorOctagonSlothRedFourHundredFiftySeven`
